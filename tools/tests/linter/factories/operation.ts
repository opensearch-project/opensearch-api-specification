...
export function mocked_operation (returned_values: MockedReturnedValues): Operation {
  ...
  if (returned_values.validate_requestBody != null) (op.validate_request as jest.Mock).mockReturnValue(returned_values.validate_requestBody)
