...
@mixin
structure UpdateByQuery_QueryParams {
    @httpQuery("analyzer")
    analyzer: Analyzer,
...
@input
structure UpdateByQuery_Input with [UpdateByQuery_QueryParams] {
    @required
    @httpLabel
    index: PathIndices,
    @httpPayload
    content: UpdateByQuery_BodyParams,
}

// TODO: Fill in Output Structure
structure UpdateByQuery_Output {}
