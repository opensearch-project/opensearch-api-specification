...
- Added `IndexSettingsReplication` schema and nested `replication` property to `IndexSettings` ([#1104](https://github.com/opensearch-project/opensearch-api-specification/pull/1104))
