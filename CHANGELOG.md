...
- Added `supports_structured_output` to `Action` schema for ML connector actions ([#1130](https://github.com/opensearch-project/opensearch-api-specification/pull/1130))
