...
- Added derived field schema for index templates, index mappings and search ([#967](https://github.com/opensearch-project/opensearch-api-specification/pull/976))
