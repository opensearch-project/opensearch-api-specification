...
- Fixed `indices.shard_stores` `ShardStoreException` schema to use `ErrorCause` to match server serialization via `OpenSearchException.generateThrowableXContent` ([#1109](https://github.com/opensearch-project/opensearch-api-specification/pull/1109))
