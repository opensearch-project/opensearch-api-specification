...
- Add `x-protobuf-name` vendor extension and add index parameters to search and bulk API ([#992](https://github.com/opensearch-project/opensearch-api-specification/pull/992))
