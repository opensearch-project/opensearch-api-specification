...
- Replaced Node.js spec test runner with a Go implementation, eliminating ~700 transitive npm dependencies in favor of ~12 Go modules ([#1125](https://github.com/opensearch-project/opensearch-api-specification/pull/1125))
