...
- Added `skip_existing` to the `text_embedding`, `sparse_encoding` and `text_image_embedding` ingest processors ([#1254](https://github.com/opensearch-project/opensearch-api-specification/pull/1254))
