...
- Fixed integer type mismatches across ML, security_analytics, indices, flow_framework, msearch, and notifications specs, and corrected path parameter cardinality for `snapshot.delete`, `snapshot.delete_repository`, and `ingest.get_pipeline` ([#1110](https://github.com/opensearch-project/opensearch-api-specification/pull/1110))
