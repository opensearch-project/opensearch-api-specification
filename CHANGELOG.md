...
- Remove unsupported `PinnedQuery` and mark x-version-deprecated to field `cutoff_frequency` in `MultiMatchQuery` ([#998](https://github.com/opensearch-project/opensearch-api-specification/pull/998))
