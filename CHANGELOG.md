...
- Added Workload Management Stats APIs (`GET /_wlm/stats` and node/workload-group variants) and the paginated `GET /_list/wlm_stats` API ([#913](https://github.com/opensearch-project/opensearch-api-specification/issues/913))
