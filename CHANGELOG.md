...
- Added `decoder_type` and `decoder_settings` to the IngestionSource under index settings ([#1199](https://github.com/opensearch-project/opensearch-api-specification/pull/1199))
