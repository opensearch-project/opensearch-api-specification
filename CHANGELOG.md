...
### Fixed
- Fixed `PluginStats` to no longer require `opensearch_version`, which is omitted from `nodes.info` plugin entries in some OpenSearch responses ([#1239](https://github.com/opensearch-project/opensearch-api-specification/pull/1239))
